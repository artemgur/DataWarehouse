...
class EventsToProductsTask(luigi.Task):
    def run(self):
        ...
        event_view_max_time = event_view_max_time_query[0][0] if len(event_view_max_time_query) > 0 else datetime.datetime.min
        ...
        event_click_max_time = event_click_max_time_query[0][0] if len(event_click_max_time_query) > 0 else datetime.datetime.min
